...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡Watch How 2 Download Movies⚡", url='https://t.me/krbackup/7')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Join Backup Channel⚡', url='https://t.me/krbackup'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/kdbhaiadmin')
        ], [
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("Hey Baby😍 Sirf Movie Name Likho.Agar Uske Baad Bhi Movie Na Mile Wait Karo 24 hour Ke Andar Upload Ho jayega Ya Admin Ko Msg Karo @Kdbhaiadmin")
    ...
    await msg.reply("Hey Baby😍 Sirf Movie Name Likho.Agar Uske Baad Bhi Movie Na Mile Wait Karo 24 hour Ke Andar Upload Ho jayega Ya Admin Ko Msg Karo @Kdbhaiadmin",
                    reply_markup=InlineKeyboardMarkup(btn))
