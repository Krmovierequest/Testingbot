...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ Join Our Backup Channel⚡', url=f"https://t.me/krbackup"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Join⚡', url='https://t.me/krbackup'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/kdbhaiadmin')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('Join Our Backup Channel', url='https://t.me/krbackup') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
